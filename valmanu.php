...
<body>
    ...
    const delay = Math.min(Math.pow(2, attempt) * 1000, 10000); // Max delay reduced to 10s
    ...
    if (attempt === 5) {
        ...
        setTimeout(() => retryNotice.remove(), 5000); // Remove notice after 5 seconds
    }
