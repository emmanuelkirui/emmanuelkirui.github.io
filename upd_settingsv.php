    ...
    <script>
        ...
        function updateUsername() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    document.getElementById('new_username').value = ''; // Clear input
                }
            });
        }
        ...
        function updateFullName() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    document.getElementById('new_full_name').value = ''; // Clear input
                }
            });
        }
        ...
        function updatePassword() {
            ...
            .then(data => {
                alert(data.message);
                if (data.success) {
                    document.getElementById('current_password').value = ''; // Clear input
                    document.getElementById('new_password').value = ''; // Clear input
                    document.getElementById('confirm_password').value = ''; // Clear input
                }
            });
        }
        ...
        function deleteAccount() {
            ...
            if (confirm('Are you sure you want to delete your account? This cannot be undone.')) {
                ...
                .then(data => {
                    alert(data.message);
                    if (data.success) {
                        document.getElementById('delete_password').value = ''; // Clear input
                        if (data.redirect) {
        ...
        function adminUpdateUser() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    loadAllUsers();
                    document.getElementById('admin_user_id').value = ''; // Clear input
                    document.getElementById('admin_username').value = ''; // Clear input
                    document.getElementById('admin_email').value = ''; // Clear input
                    document.getElementById('admin_full_name').value = ''; // Clear input
                    document.getElementById('admin_user_type').value = 'user'; // Reset to default
                }
            });
        }
