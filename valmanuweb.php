...
function predictMatch($match, $apiKey, $baseUrl, &$teamStats, $competition) {
    try {
        ...
        $drawLikelihood = ($homeDrawRate + $awayDrawRate) * $drawWeight * 0.8; // Increased draw sensitivity
        $diffThreshold = 0.6; // Widened threshold for draws
        ...
        // Prediction Logic
        if ($diff > 0.6) { // Tightened threshold for clear win
