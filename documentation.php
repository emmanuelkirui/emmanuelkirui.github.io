    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            padding-top: 100px; /* Increased padding to fully clear the header */
        }
        ...
        .header-content {
            ...
            align-items: center;
            padding: 0 20px;
            height: 100%; /* Ensure content fits within header height */
        }

        .header-content h1 {
            font-size: 1.5rem; /* Reduced size to prevent overflow */
        }
        ...
        .toc {
            width: 300px;
            position: sticky;
            top: 120px; /* Adjusted to account for increased body padding */
    ...
    <script>
        ...
        document.querySelectorAll('.toc a, .sidebar a').forEach(anchor => {
            anchor.addEventListener('click', function(e) {
                ...
                // Close mobile menu and sidebar after clicking a link
